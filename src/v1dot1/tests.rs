...
fn parse_appendix_adot1() {
    let alert: Alert = include_str!("../../fixtures/v1dot1_appendix_adot1.xml")
        .parse()
        .unwrap();
...
fn parse_appendix_adot2() {
    let alert: Alert = include_str!("../../fixtures/v1dot1_appendix_adot2.xml")
        .parse()
        .unwrap();
...
fn parse_appendix_adot3() {
    let alert: Alert = include_str!("../../fixtures/v1dot1_appendix_adot3.xml")
        .parse()
        .unwrap();
...
fn parse_appendix_adot4() {
    let alert: Alert = include_str!("../../fixtures/v1dot1_appendix_adot4.xml")
        .parse()
        .unwrap();
